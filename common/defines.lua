...
country = {
	...
	NAVAL_BASE_SUPPLY_SCORE_BASE = 1000, -- base value that is powered by level of naval base. Determines the naval supplying capabilities.
	NAVAL_BASE_SUPPLY_SCORE_EMPTY = 1000, -- min value for coastal provinces with no naval base.
...
military = {
	...
	AI_BIGSHIP_PROPORTION = 0.8, -- fraction of ships in the navy that should be ships of the line
	AI_LIGHTSHIP_PROPORTION = 0.0, -- fraction of ships in the navy that should be cruisers, frigates etc
...
ai =
{
	...
	CHANCE_BUILD_RAILROAD = 0.99, -- chances in % of AI decisions (max value 1.0)
